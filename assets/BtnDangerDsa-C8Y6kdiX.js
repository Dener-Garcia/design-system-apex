 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=["svg",n,[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16"}],["path",{d:"M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7"}]]];/**
 * @license lucide v0.446.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=["svg",n,[["path",{d:"m6 9 6 6 6-6"}]]];/**
 * @license lucide v0.446.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=["svg",n,[["path",{d:"m9 10 2 2 4-4"}],["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2"}],["path",{d:"M12 17v4"}],["path",{d:"M8 21h8"}]]];/**
 * @license lucide v0.446.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const a=document.querySelectorAll(`[${t}]`);if(Array.from(a).forEach(o=>C(o,{nameAttr:t,icons:e,attrs:r})),t==="data-lucide"){const o=document.querySelectorAll("[icon-name]");o.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(o).forEach(l=>C(l,{nameAttr:"icon-name",icons:e,attrs:r})))}};E({icons:{Users:N,ChartSpline:S,MonitorCheck:M,Puzzle:I,ChevronDown:F,CodeXml:L}});const h=document.createElement("div"),x=`- BtnPriDsa:
    ...
    Properties:
      ...
      X: =42
      Y: =237
`;h.setAttribute("data-code",x);h.innerHTML='<button class="BtnPriDsa">teste</button>';const p=document.createElement("div"),W=`- BtnIcnPriDsa:
...
`;p.setAttribute("data-code",W);const O='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-plus"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 15h6"/><path d="M12 18v-6"/></svg>';p.innerHTML=`<button class="BtnIcnPriDsa">${O}</button>`;const T=document.createElement("div"),$=`- BtnIcnSecDsa:
    Control: GroupContainer@1.3.0
    Variant: ManualLayout
    Properties:
      DropShadow: =DropShadow.None
    ...
    Children:
      ...
      - BtnTerSec:
          ...
          Properties:
            ...
            Width: =Parent.Width
            Y: '=0'
`;g.setAttribute("data-code",X);const z='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-plus"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 15h6"/><path d="M12 18v-6"/></svg>';g.innerHTML=`<button class="BtnIcnTerDsa">${z}</button>`;const k=document.createElement("div"),G=`- BtnTerDsa:
    Control: Classic/Button@2.2.0
    Properties:
      BorderColor: |-
        =ColorValue(
      ...
      X: =458
      Y: =237
`;k.setAttribute("data-code",G);k.innerHTML='<button class="BtnTerDsa">Label</button>';const B=document.createElement("div"),j=`- BtnSecDsa:
    Control: Classic/Button@2.2.0
    Properties:
      BorderColor: |-
        =ColorValue(
      ...
      X: =243
      Y: =237
`;B.setAttribute("data-code",j);B.innerHTML='<button class="BtnSecDsa">teste</button>';const m=document.createElement("div"),Z=`- BtnIcnLfDsa:
    Control: GroupContainer@1.3.0
    Variant: ManualLayout
    Properties:
      DropShadow: =DropShadow.None
